...
@Autonomous(name = "Sample Auto V3", group = "Coach")
public class BucketAutoV3 extends OpMode {
    ...
    private final Pose pickup3Pose = new Pose(24, 131.5, Math.toRadians(25));
     ...
     * The
     * will not go to this pose, it is used a control point for our bezier curve. */
            ...
            case 1:
                ...
                */
                ...
                if(!follower.isBusy()) {
                    ...
                    else if(pathFollowed && robot.systemState == RobotV2.SystemStates.LOW_HOVER && robot.stateFinished){
                        robot.setSystemState(RobotV2.SystemStates.DOWN_ON_SAMPLE);
                    }
                    else if(robot.systemState == RobotV2.SystemStates.INTAKE_GRIPPERS_OPEN_SLIDES_OUT && robot.stateFinished) {
                        setPathState(2);
                        stateTimer.reset();
                        pathFollowed = false;
                        robot.lastButtonPressed = 0;
                    }
                }
                break;
            case 2:
    ...
    public void start() {
        ...
        stateTimer.reset();
        pathTimer.resetTimer();
        robot.setSystemState(RobotV2.SystemStates.INTAKE_GRIPPERS_OPEN_SLIDES_OUT);
        setPathState(0);
    }
